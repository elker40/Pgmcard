...
#line 1 "..\..\SrcCode\Logic\Core\Battery.c" /0
...
#line 1 "..\..\SrcCode\Logic\Core\Battery.c" /0
 ...
 uint32_t AdcValue;
 uint16_t AdcVoltage;
 uint16_t BatVoltage[9];           
 
 void BatInit(void)
 {
 IdxChs = 0; AdcCovOkFlag = 0;
  ADC0CN0_ADBUSY = 0x1;;
 }
 
 void BatDatProcess(void)
 {
 if(AdcCovOkFlag == 0x1){
 AdcValue = ADC0;
 ...
 case 1: AMX0P = 0x0E; break;   
 case 2: AMX0P = 0x0D; break;   
 case 3: AMX0P = 0x0C; break;   
 case 4: AMX0P = 0x0B; break;   
 case 5: AMX0P = 0x0A; break;   
 case 6: AMX0P = 0x09;  break;   
 case 7: AMX0P = 0x02;  break;   
 }
 ADC0CN0_ADBUSY = 1;
 }else{
 ...
 void ADC0EOC_ISR(void) interrupt 10 
 { 
 ADC0CN0_ADINT = 0;        
