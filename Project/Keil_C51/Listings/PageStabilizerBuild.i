...
#line 1 "..\..\SrcCode\Middle\Gui\Page\PageStabilizerBuild.c" /0
...
#line 1 "..\..\SrcCode\Middle\Gui\Page\PageStabilizerBuild.c" /0
 ...
 uint8_t  data PageStablizerBindTickOverFlow;
 uint16_t data PageStablizerBindTickCnt;
 
 uint8_t PageStablizerBuild(uint8_t event){
 if(event == PV_INIT){
 LcdDrawClr(0);
 LcdDrawTextString(3, 0, "DSM Bind");
 LcdDrawHLine(0, 128-1, 14, 1);
 StabilizerParam[17] = 0x1;
 IdxStatue = 0x00; 
