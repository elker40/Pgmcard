...
#line 1 "..\..\SrcCode\Logic\Core\InterruptIsp.c" /0
...
#line 1 "..\..\SrcCode\Logic\Inc\Debug.h" /0
...
#line 4 "..\..\SrcCode\Logic\Inc\Debug.h" /0
 
 
 extern void DebugMessage(uString StrText);
 
 
#line 9 "..\..\SrcCode\Logic\Inc\Debug.h" /1
...
#line 21 "..\..\SrcCode\Logic\Inc\Debug.h" /0
 
 
 
 
#line 2 "..\..\SrcCode\Logic\Core\InterruptIsp.c" /0
 
 
 void INT0_ISR (void) interrupt 0 using 3   
 { 
 while(1){
 DebugMessage("DisableIsp Error!");
 }
 }
 void INT1_ISR (void) interrupt 2 using 3   
 { 
 while(1){
 DebugMessage("DisableIsp Error!");
 }  
 ...
 void SMBUS0_ISR (void) interrupt 7 using 3   
 {
 while(1){
 DebugMessage("DisableIsp Error!");
 }  
 }
 void USB0_ISR (void) interrupt 8 using 3   
 { 
 while(1){
 DebugMessage("DisableIsp Error!");
 }  
 }
 void ADC0WC_ISR (void) interrupt 9 using 3   
 {
 while(1){
 DebugMessage("DisableIsp Error!");
 }  
 }
 void ADC0EOC_ISR (void) interrupt 10 using 3   
 { 
 while(1){
 DebugMessage("DisableIsp Error!");
 }  
 }
 void PCA0_ISR (void) interrupt 11 using 3   
 {   
 while(1){
 DebugMessage("DisableIsp Error!");
 }
 }
 void CMP0_ISR (void) interrupt 12 using 3   
 {  
 while(1){
 DebugMessage("DisableIsp Error!");
 }
 }
 void CMP1_ISR (void) interrupt 13 using 3   
 { 
 while(1){
 DebugMessage("DisableIsp Error!");
 }  
 ...
 void VBUSLVL_ISR (void) interrupt 15 using 3   
 { 
 while(1){
 DebugMessage("DisableIsp Error!");
 }  
 ...
 void SMBUS1_ISR (void) interrupt 18 using 3   
 {  
 while(1){
 DebugMessage("DisableIsp Error!");
 }
 }
 void TIMER4_ISR (void) interrupt 19 using 3  
 { 
 while(1){
 DebugMessage("DisableIsp Error!");
 }  
 }
 void TIMER5_ISR (void) interrupt 20 using 3   
 {  
 while(1){
 DebugMessage("DisableIsp Error!");
 }
