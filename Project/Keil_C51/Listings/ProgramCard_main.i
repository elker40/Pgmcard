...
#line 1 "..\..\SrcCode\Logic\Core\ProgramCard_main.c" /0
...
#line 7 "..\..\SrcCode\Middle\Gui\Inc\Page.h" /0
 ...
 extern uint8_t PageEscSkyLordRst(uint8_t event);
 extern uint8_t PageEscAutoMobileRst(uint8_t event);
...
#line 2 "\CurWsp\Detrum_PgmCard\SrcCode\Logic\Inc\Stablizer.h" /1
...
#line 4 "..\..\SrcCode\Logic\Core\ProgramCard_main.c" /0
 
 
 void SysHandleProcess(uint8_t HandleCfg)
 { 
 if(HandleCfg&0x02) _nop_();
 if(HandleCfg&0x04) _nop_();
 if(HandleCfg&0x08) LipoCellsProcessHandle();
 if(HandleCfg&0x10) StablizerProcessHandle();  
 }
 ...
 if(SysModuleEnable&0x04){
 if(EscParam[23] == 0x01){         
 SysTaskHandle |= 0x02;
 PageInit(PageAircraftEsc, PV_INIT);
 }else if(EscParam[23] == 0x02){ 
 SysTaskHandle |= 0x04;
 PageInit(PageAutoMobileEsc, PV_INIT);
 }
 }else if(SysModuleEnable&0x02){
 SysTaskHandle |= 0x08;
 PageInit(PageBatVolt, PV_INIT);
 }else if(SysModuleEnable&0x01){
 SysTaskHandle |= 0x10;
