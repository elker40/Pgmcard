...
#line 1 "..\..\SrcCode\Logic\Core\Esc.c" /0
...
#line 1 "..\..\SrcCode\Logic\Core\Esc.c" /0
 ...
 uint8_t  PgmStatus;
 int16_t  EscParam[24];
 int16_t  EscTxParam[24];
 
 uint8_t  TxInitPulse;                    
 uint8_t  RxDataEnable;                   
 uint8_t  TxNextDelayCnt;
 
 uint8_t  InPulseIdx, OutPulseIdx;
 uint16_t data InitPulseCnt, DataPulseCnt;
 
 uint8_t data PwmOnRef;                  
 int16_t data PwmOutCnt, PwmOutNum;
 ...
 uint8_t i;  
  ...
  TCON_IE0 = 0; IE_EX0 = 0; _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); RC_OUT = 0; P0MDOUT = (P0MDOUT&(~0x10))|0x10; P0MDIN = (P0MDIN&(~0x10))|0x10;;  
 TxInitPulse = 1;
 RxDataEnable = 0; 
 
 
 TCON_TF0 = 1;
 while(InitPulseCnt < 2); TCON_TR0 = 0;    
 
 
  P0MDOUT = (P0MDOUT&(~0x10))|0x00; P0MDIN = (P0MDIN&(~0x10))|0x10; RC_OUT = 1; _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); TCON_IE0 = 0; IE_EX0 = 1;;  
 TxInitPulse = 0;
 RxDataEnable = 1;   
 DelayMs(1200);                           
...
#line 77 "..\..\SrcCode\Logic\Core\Esc.c" /1
 
 
 
 
 
#line 82 "..\..\SrcCode\Logic\Core\Esc.c" /0
 for(i = 1; i < 16; i++){								 
 if(EscParam[i] != 0) SysModuleEnable |= 0x04;; 
 }
 }                      
 ...
 int16_t  EscDatSum, EscDatSumPre;  
