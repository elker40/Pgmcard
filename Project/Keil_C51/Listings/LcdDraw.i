...
#line 1 "..\..\SrcCode\Middle\Gui\Core\LcdDraw.c" /0
  
#line 1 "..\..\SrcCode\Middle\Gui\Inc\LcdDraw.h" /0
...
#line 4 "\PgmCard\SrcCode\Bsp\Inc\TypeDef.h" /0
...
#line 5 "\PgmCard\SrcCode\Bsp\Inc\TypeDef.h" /0
...
#line 7 "\PgmCard\SrcCode\Bsp\Inc\TypeDef.h" /0
...
#line 2 "\PgmCard\SrcCode\Middle\Gui\Inc\LcdDraw.h" /1
...
#line 4 "..\..\SrcCode\Middle\Gui\Inc\LcdDraw.h" /0
...
#line 5 "..\..\SrcCode\Middle\Gui\Inc\LcdDraw.h" /0
...
#line 6 "..\..\SrcCode\Middle\Gui\Inc\LcdDraw.h" /0
...
#line 7 "..\..\SrcCode\Middle\Gui\Inc\LcdDraw.h" /0
...
#line 1 "..\..\SrcCode\Middle\Gui\Core\LcdDraw.c" /0
 ...
 uint8_t  LcdDispImg[128 * 8];
 uint8_t  LcdDispBuf[128];
 ...
 uint8_t  LcdDir = 0;  
 uint16_t  LcdXpos = 0, LcdYpos = 0;  
 uint16_t  LcdLeft = 0, LcdRight = 0;  
 ...
 uint8_t  YColumn = LcdYpos / 0x08;
 uint8_t  YByteIdxBit = LcdYpos % 0x08;
 
 if (Color) {
 LcdDispImg[YColumn * 128 + LcdXpos] |= 1 << YByteIdxBit;
 } else {
 LcdDispImg[YColumn * 128 + LcdXpos] &= ~(1 << YByteIdxBit);
 }
 ...
 int16_t  t = 0;
 int16_t  dx = 0, dy = 0, err = 0, steep = 0, ystep = 0;
 ...
 uint8_t  iPix = 0, uPixDat = 0;
 uint16_t  iWidth = 0, iHeight = 0;
 
 uint16_t  iDat = (uint16_t)pImageDat[0x0A];
 uint16_t  iImgWidth = ((uint16_t)(*(pImageDat + 0x13)) << 8)|((uint16_t)(*(pImageDat + 0x12)));
 uint16_t  iImgHeight = ((uint16_t)(*(pImageDat + 0x17)) << 8)|((uint16_t)(*(pImageDat + 0x16)));
 ...
 uint8_t *  pBmpAscChar = AscFontTableMask + (uint16_t) iAsc * 6;
 ...
 uint16_t  i = 0;
 uint16_t  iChsTmp = 0, cDatLine = 0;
 
 uint8_t *  pBmpChsChar = ((void *)0);
 ...
 {
 int16_t  ValueTmp, mask;
 uint8_t  w, i, sz, minus = ' ';
 ...
 if(c >= 'A'&&c <= 'Z') LcdDrawMiniBmp(x, y, (c-'A'+23));
 else if(c >= '0'&&c <= '9') LcdDrawMiniBmp(x, y, c-'0');
 else if(c==' ') LcdDrawMiniBmp(x, y, 15);
 ...
 {
 int16_t  ValueTmp = 0, mask = 0;
 uint8_t  w = 0, sz = 0, i = 0, minus = 15;
