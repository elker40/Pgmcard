...
#line 1 "..\..\SrcCode\Logic\Core\Interrupts.c" /0
...
#line 10 "..\..\SrcCode\Logic\Core\Interrupts.c" /0
...
#line 11 "..\..\SrcCode\Logic\Core\Interrupts.c" /0
...
#line 11 "D:\MyProKits\MucKits\Keil_C51_Rev956\C51\Inc\Limits.h" /1
...
#line 12 "..\..\SrcCode\Logic\Core\Interrupts.c" /0
 
 
 uint8_t  TickTime100ms = 0;    
 uint8_t  TickTime500ms = 0;    
 uint8_t  TickTime1000ms = 0;   
 
 void TIMER0_ISR (void) interrupt 1 using 1  
 {
 TH0 = (uint8_t)((0xFFFF-10000)/0xFF);
 TL0 = (uint8_t)((0xFFFF-10000)%0xFF);
 ...
 uint8_t  RX_Data;
 uint8_t  state, rx_len, rx_cnt;
 
 void UART1_ISR (void) interrupt 16 using 2   
 {  
 if(SCON1 & 0x01) {
 SCON1 &=  ~0x01;
 RX_Data = SBUF1;
