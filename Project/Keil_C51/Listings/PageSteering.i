...
#line 1 "..\..\SrcCode\Middle\Gui\Page\PageSteering.c" /0
...
#line 1 "..\..\SrcCode\Middle\Gui\Page\PageSteering.c" /0
 ...
 uString code PageOptionSterringMode[] = {
 "Auto", "Manual", "Neutral", "Maximum", "Minimum"
 };
 MenuItem code MenuItemSterring[] = { 
 {"Sterring",0,0,0,3,0,0,0 },
 {"TestMode:", 0,PageOptionSterringMode, 0,4, 		 &SterringParam[0x00], 0,0},
 {"AutoStep:",	0,0, 										  0,+50,   &SterringParam[0x02], 0,0},
 {"Location:",	0,0, 											-50,+50, &SterringParam[0x01], 0,0}
 };
 ...
 SterringMs.ItemEdit = 1; SterringMs.DrawMask |= PD_VALUE;
 }
 }
 if(BtnTstDown(((uint8_t)(0x08)))){
 if(SterringMs.ItemEdit == 1){
 SterringMs.ItemEdit = 0; SterringMs.DrawMask |= PD_VALUE;
 }else{
 PageReturn(PV_INIT);
 }
 }
