...
#line 1 "..\..\SrcCode\Middle\Input\Core\InputBtn.c" /0
...
#line 1 "..\..\SrcCode\Middle\Input\Core\InputBtn.c" /0
 ...
 uint8_t data BtnTickOverFlow;
 uint16_t data BtnTickCnt;
 ...
 uint8_t  BtnCnt;  
 uint8_t  BtnStat, BtnHold, BtnDown;  
 uint8_t  BtnTmpCache;  
 uint8_t  BtnHoldBuffer, BtnDownBuffer;  
 ...
 BtnCnt = 0x00;
 BtnStat = ((uint8_t)(((uint8_t)(0x04))|((uint8_t)(0x08))|((uint8_t)(0x01))|((uint8_t)(0x02)))); BtnHold = ((uint8_t)(((uint8_t)(0x04))|((uint8_t)(0x08))|((uint8_t)(0x01))|((uint8_t)(0x02)))); BtnDown = ((uint8_t)(((uint8_t)(0x04))|((uint8_t)(0x08))|((uint8_t)(0x01))|((uint8_t)(0x02))));
 BtnTmpCache = ((uint8_t)(((uint8_t)(0x04))|((uint8_t)(0x08))|((uint8_t)(0x01))|((uint8_t)(0x02)))); BtnHoldBuffer = ((uint8_t)(((uint8_t)(0x04))|((uint8_t)(0x08))|((uint8_t)(0x01))|((uint8_t)(0x02)))); BtnDownBuffer = ((uint8_t)(((uint8_t)(0x04))|((uint8_t)(0x08))|((uint8_t)(0x01))|((uint8_t)(0x02))));
 }
 
 void BtnScanHandle(void){
 uint8_t data BtnTmp = ((uint8_t)(((uint8_t)(0x04))|((uint8_t)(0x08))|((uint8_t)(0x01))|((uint8_t)(0x02))));
 
  TCON_IT1 = 0;
 if(BtnTickOverFlow == 0x1){
 if(TickCnt1ms > (0xFFFF)-10){
  TCON_IT1 = 1;
 return;
 }
 BtnTickOverFlow = 0x0;
 ...
 if(BtnGetState(((uint8_t)(0x01))) == 0x01) BtnTmp &= (uint8_t)(~((uint8_t)(0x01)));
 if(BtnGetState(((uint8_t)(0x02))) == 0x01) BtnTmp &= (uint8_t)(~((uint8_t)(0x02)));
 if(BtnGetState(((uint8_t)(0x04))) == 0x01) BtnTmp &= (uint8_t)(~((uint8_t)(0x04)));
 if(BtnGetState(((uint8_t)(0x08))) == 0x01) BtnTmp &= (uint8_t)(~((uint8_t)(0x08)));	  
 
 if(BtnTmpCache == BtnTmp){		
 BtnStat = BtnTmpCache;
 if((BtnStat&((uint8_t)(((uint8_t)(0x04))|((uint8_t)(0x08))|((uint8_t)(0x01))|((uint8_t)(0x02))))) != ((uint8_t)(((uint8_t)(0x04))|((uint8_t)(0x08))|((uint8_t)(0x01))|((uint8_t)(0x02))))){
 if(BtnCnt == 0){
   _nop_();
 BtnDown &= BtnStat;
 }else{
 ...
 BtnDown &= BtnStat|((uint8_t)(0x08))|((uint8_t)(0x04));          
 BtnHold &= BtnStat;
 if(BtnDown != BtnDownBuffer){ _nop_(); }
 else if(BtnHold != BtnHoldBuffer) { _nop_(); }
 BtnCnt = 100 - 10;
 }
 }
 BtnCnt++;
 ...
 void BtnFlush(void){
 BtnDown = BtnStat = BtnHold = ((uint8_t)(((uint8_t)(0x04))|((uint8_t)(0x08))|((uint8_t)(0x01))|((uint8_t)(0x02))));
 BtnCnt = 0x00;
 }
