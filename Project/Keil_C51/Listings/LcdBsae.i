...
#line 1 "..\..\SrcCode\Middle\Gui\Core\LcdBsae.c" /0
  
#line 1 "..\..\SrcCode\Middle\Gui\Inc\LcdBase.h" /0
...
#line 12 "..\..\SrcCode\Middle\Gui\Inc\LcdBase.h" /0
...
#line 2 "\PgmCard\SrcCode\Middle\Gui\Inc\LcdBase.h" /1
...
#line 13 "..\..\SrcCode\Middle\Gui\Inc\LcdBase.h" /0
...
#line 14 "..\..\SrcCode\Middle\Gui\Inc\LcdBase.h" /0
...
#line 4 "..\..\SrcCode\Middle\Gui\Core\LcdBsae.c" /1
  
 
 
 
 
#line 9 "..\..\SrcCode\Middle\Gui\Core\LcdBsae.c" /0
 
 
 
 
 static void Delay(uint8_t nTim) {
 volatile uint8_t  nCnt = nTim;
 while((--nCnt) > 0);
 }
 static void Spi_Inti(void){
 
#line 19 "..\..\SrcCode\Middle\Gui\Core\LcdBsae.c" /1
 
 
#line 21 "..\..\SrcCode\Middle\Gui\Core\LcdBsae.c" /0
 LCD_CS = 0;
...
#line 27 "..\..\SrcCode\Middle\Gui\Core\LcdBsae.c" /1
...
#line 40 "..\..\SrcCode\Middle\Gui\Core\LcdBsae.c" /0
...
#line 61 "..\..\SrcCode\Middle\Gui\Core\LcdBsae.c" /1
 
 
#line 63 "..\..\SrcCode\Middle\Gui\Core\LcdBsae.c" /0
 Spi_sWriteByte(uCmd);
...
#line 69 "..\..\SrcCode\Middle\Gui\Core\LcdBsae.c" /1
 
 
#line 71 "..\..\SrcCode\Middle\Gui\Core\LcdBsae.c" /0
 Spi_sWriteByte(uDat);
 ...
 uint8_t  iPage = 0, iColumn = 0;
 
 mBw = mBw ? 0xFF : 0x00;
 for (iPage = 0; iPage < 8; iPage++) {
 Lcd_SetPage(iPage);
 Lcd_SetColumn(0);
 for (iColumn = 0; iColumn < 128; iColumn++) {
 Lcd_Dat(mBw);
 }
 }
 }
 ...
 uint8_t  iAscMask = 0, AskMaskDat = 0;
 uint8_t *  pAscMask = AscFontTableMask + (uint16_t) iAsc * 6;
 ...
 extern uint8_t  LcdDispImg[128 * 8];
 extern uint8_t  LcdDispBuf[128];
 
 void LcdDrawBufferRefresh(void) {
 uint8_t  Idx = 0;
 uint8_t  Init = 0;
 uint16_t  iPage = 0, iColumn = 0, iColumnCache = 0;
 ...
 Lcd_Dat(LcdDispImg[iPage * 128 + iColumn]);
