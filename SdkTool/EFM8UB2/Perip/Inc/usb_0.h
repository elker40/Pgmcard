...
#else
#define USB_EnableInts() EIE1 |= EIE1_EUSB0__ENABLED;
#endif
...
#else
#define USB_DisableInts() EIE1 &= ~EIE1_EUSB0__ENABLED;
#endif
 ...
 ******************************************************************************/
#ifdef IS_DOXYGEN
extern bool USB_VbusDetectEnable(void);
#else
 ...
 ******************************************************************************/
#ifdef IS_DOXYGEN
extern bool USB_VbusDetectDisable(void);
#else
...
#else
#define USB_EnablePullUpResistor() USB0XCN |= USB0XCN_PREN__PULL_UP_ENABLED;
#endif
...
#else
#define USB_DisablePullUpResistor() USB0XCN &= ~USB0XCN_PREN__PULL_UP_ENABLED;
#endif
...
#else
#define USB_EnableTransceiver() USB0XCN |= USB0XCN_PHYEN__ENABLED;
#endif
...
#else
#define USB_DisableTransceiver() USB0XCN &= ~USB0XCN_PHYEN__ENABLED;
#endif
...
#else
#define USB_SelectFullSpeed() USB0XCN |= USB0XCN_SPEED__FULL_SPEED;
#endif
...
#else
#define USB_SelectLowSpeed() USB0XCN &= ~USB0XCN_SPEED__FULL_SPEED;
#endif
...
#else
#define USB_SetClockIntOsc() CLKSEL &= ~CLKSEL_USBCLK__FMASK;
#endif
...
#else
#define USB_DisablePrefetch() (PFE0CN &= ~PFE0CN_PFEN__ENABLED)
#endif
...
#else
#define USB_EnablePrefetch() (PFE0CN |= PFE0CN_PFEN__ENABLED)
#endif
...
#else
#define USB_SuspendOscillator() HFO0CN |= HFO0CN_SUSPEND__ENABLED;
#endif
